...
- `terraform/azure/aks/dev-workspace.ps1` is the preferred operator entrypoint because it reinitializes Terraform, re-selects the live `dev` workspace, and refreshes `.generated-kubeconfig` from the live AKS admin credentials before plan/apply
